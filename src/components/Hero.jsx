...
const Hero = () => {
  const [mounted, setMounted] = useState(false); // Track component mount status
  const typewriterRef = useRef(null); // Create a reference for Typewriter

  useEffect(() => {
    setMounted(true); // Set mounted state to true after component is mounted
  }, []);
